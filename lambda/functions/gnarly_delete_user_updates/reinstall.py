...
def uninstall(function_name,additional_role_policies):
...
def install(function_name,additional_role_policies,api_source_arn):
  lambda_client = boto3.client('lambda')
  iam_client = boto3.client('iam')
...
def reinstall(function_name,additional_role_policies,api_source_arn):
  uninstall(function_name,additional_role_policies)
  install(function_name,additional_role_policies,api_source_arn)

reinstall("gnarly-delete-user-updates",['lambda-delete-data'],'arn:aws:execute-api:eu-west-2:081277733545:z4oiwf4tli/*/GET/delete-user-updates')
